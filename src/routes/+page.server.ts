...
const ICS_URL =
  'https://calendar.google.com/calendar/ical/bee0a4ff591a63c015084a9d2770b82ca06813f1c223c6077b688f537cc6cde1%40group.calendar.google.com/public/basic.ics';
...
function selectHighlights(
  images: { src: string; alt: string; date: number }[],
  count: number,
  seed: number,
